        ...
        <Row>
          <Col lg={6} md={6} sm={12} xs={12}>
            <Card className={styles.card}>
              ...
              <InputField label={'Message'} type={'textarea'} name={'message'} value={userDetails.message} placeholder={'Hey Avanthika Chennamadhavuni, I love your website! I\'d like to discuss some opportunities that you might find interesting! 💐'} required={true} rows={10} cols={12} onChange={handleChange} error={validationErrors.message} />
              <Button className={`${styles.hireMeButton} mt-4`} onClick={onSubmitHandler} disabled={!buttonDisabled}  >    Send Message  </Button>
              <p className={`${styles.copyRights} mt-4`}>Copyrights © 2024 Avanthika Portfolio</p>
              <p className={`${styles.copyRights} mb-4`} > Designed and Developed by Avanthika Chennamadhavuni</p>
            </Card>
          </Col>
          <Col lg={6} md={6} sm={12} xs={12}>
          </Col>
